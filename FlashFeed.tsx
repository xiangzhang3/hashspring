...
// ââ Extract keywords from title for internal linking ââ
        ...
        return (
          <div key={item.id}>
            <div className="flex gap-0 relative">
              ...
              {/* ââ Timeline Axis ââ */}
              <div className="w-6 flex flex-col items-center flex-shrink-0">
                {/* Dot â analysis uses a special purple dot */}
              ...
              <Link href={href} prefetch={false} className="flex-1 no-underline group">
                {isAnalysis ? (
                  /* âââ ANALYSIS CARD â larger, prominent style âââ */
                  ...
                  ">
                    ...
                    {/* Description â more visible for analysis */}
                    {item.description && (
                    ...
                    <div className="flex items-center justify-between mt-3 pt-2 border-t border-purple-100/60 dark:border-purple-800/30">
                      <span className="text-[11px] font-semibold text-purple-500 dark:text-purple-400 group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors flex items-center gap-1">
                        {isZh ? 'é±è®å¨æ' : 'Read full analysis'}
                  ...
                  /* âââ REGULAR FLASH CARD âââ */
